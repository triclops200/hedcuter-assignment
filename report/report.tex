...
focus on the edges than the voronoi\_stippler method.
...
\begin{figure}[h]
  ...
  \caption{Hedcuter (left) vs voronoi\_stippler (right) for a cartoon
    image. Note the concentration of stipples along the edges for the
    hedcut implementation.}\label{vs_b}
\end{figure}
...
\begin{figure}[h]
  ...
  \end{minipage}
  \caption{Hedcuter (left) vs voronoi\_stippler (right) for another cartoon image.}\label{vs_b}
\end{figure}
